<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-user">
            ...
            <dd>
                <ul>
                    <li><a data-href="/user/list" data-title="用户列表" href="javascript:void(0)">用户列表</a></li>
                </ul>
        ...
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a data-href="article-list.html" data-title="酒店管理" href="javascript:void(0)">酒店管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-picture">
